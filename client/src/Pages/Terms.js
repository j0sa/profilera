  ...
  return (
    <div class="terms-text-div">
      ...
      <p>
        ...
        shall manage your use of our website, Profilera accessible at
        http://www.profilera.net.
      </p>
      ...
      <p>
        ...
        written here. You must not use this Website if you disagree with any of
      ...
      <p>
        Other than the content you own, under these Terms, Profilera and/or its
      ...
      <p>
        ...
        and Profilera may further restrict access by you to any areas of this
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant Profilera
      ...
      <p>
        ...
        rights. Profilera reserves the right to remove any of Your Content from
      ...
      <p>
        This Website is provided "as is," with all faults, and Profilera express
      ...
      <p>
        {" "}
        EXCEPT AS EXPRESSLY STATED IN THESE TERMS, PROFILERA DOES NOT MAKE ANY
        REPRESENTATIONS OR WARRANTIES AND EXPLICITLY DISCLAIMS ALL OTHER
        REPRESENTATIONS AND WARRANTIES, WHETHER EXPRESS, IMPLIED, WRITTEN, ORAL
        OR STATUTORY.
      </p>
      <p>
        In no event shall Profilera, nor any of its officers, directors and
        ...
        under contract. Profilera, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent Profilera from and against
      ...
      <p>
        Profilera is permitted to revise these Terms at any time as it sees fit,
      ...
      <p>
        Profilera is allowed to assign, transfer, and subcontract its rights
      ...
      <p>
        These Terms constitute the entire agreement between Profilera and you in
      ...
      <p>
        ...
        laws of Sweden and you submit to the non-exclusive jurisdiction of the
        state and federal courts located in Sweden for the resolution of any
        disputes.
      </p>
    </div>
  );
